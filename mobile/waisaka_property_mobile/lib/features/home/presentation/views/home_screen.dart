      ...
      child: BlocListener<HomeBloc, HomeState>(
        listener: (context, state) {
          if (state is HomeNavigateToSearch) {
            // For now, show a snackbar. Later, navigate to a search results page.
            ...
            // Example navigation: context.go('/search?location=${state.location}&type=${state.type}');
          }
        },
        child: Scaffold(
          appBar: AppBar(
    ...
    return ListView(
      ...
      children: [
        _SectionHeader(
          ...
          onSeeAll: () {
            // TODO: Implement navigation to full property list screen
            ScaffoldMessenger.of(context).showSnackBar(
        ...
        _SectionHeader(
          title: 'News & Updates',
          onSeeAll: () {
            // TODO: Implement navigation to full article list screen
            ScaffoldMessenger.of(context).showSnackBar(
...
class _PropertyList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      height: 300, // Constrain height for horizontal list
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return SizedBox(
            width: 250, // Constrain width for horizontal items
            child: Card(
              elevation: 2.0,
                  ...
                  children: [
                    if (property.gambar != null)
                      Image.network(
                        ...
                        fit: BoxFit.cover,
                        errorBuilder: (_, __, ___) => const SizedBox(height: 150, child: Center(child: Icon(Icons.broken_image, size: 40))),
