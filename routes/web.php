...
Route::get('signup', 'App\Http\Controllers\Admin\User@signup');

// Rute untuk memproses form Sign Up
Route::post('signup/proses', 'App\Http\Controllers\Admin\User@proses_signup');
...
// Rute untuk mengelola paket iklan

Route::get('admin/paket-iklan', 'App\Http\Controllers\Admin\Paket_iklan@index');
Route::get('admin/paket-iklan/create', 'App\Http\Controllers\Admin\Paket_iklan@create');
Route::post('admin/paket-iklan/store', 'App\Http\Controllers\Admin\Paket_iklan@store');
Route::get('admin/paket-iklan/edit/{id}', 'App\Http\Controllers\Admin\Paket_iklan@edit');
Route::post('admin/paket-iklan/update/{id}', 'App\Http\Controllers\Admin\Paket_iklan@update');
Route::get('admin/paket-iklan/delete/{id}', 'App\Http\Controllers\Admin\Paket_iklan@destroy');
Route::post('admin/paket-iklan/proses', 'App\Http\Controllers\Admin\Paket_iklan@proses'); 

// RUTE UNTUK TRANSAKSI PAKET IKLAN
...
// Rute untuk memproses form pembelian
Route::post('admin/paket-iklan/proses-pembelian', 'App\Http\Controllers\Admin\Paket_iklan@prosesPembelian');

// Rute untuk menampilkan halaman profil member
Route::get('admin/staff/profil-member', 'App\Http\Controllers\Admin\Staff@profilMember');

// Rute untuk memproses update profil member
Route::post('admin/staff/update-profil-member', 'App\Http\Controllers\Admin\Staff@updateProfilMember');

Route::get('verify-email', 'App\Http\Controllers\Admin\User@verifyEmail');
