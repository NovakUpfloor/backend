  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      {{ csrf_field() }}
        ...
        {{-- --- AWAL BLOK CAPTCHA BARU --- --}}
        <div class="form-group">
            <label>Jawab captcha dengan benar !!!</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text captcha-box">{{ $captcha_question }}</span>
                </div>
                <input type="text" name="captcha" class="form-control" placeholder="Masukkan kode di samping" required>
                <div class="input-group-append">
                    <div class="input-group-text">
        ...
        <div class="col-6">
        <a href="{{ asset('signup') }}" class="btn btn-block btn-secondary">
          <i class="fas fa-user-plus mr-2"></i> Sign Up / Daftar
        </a>
        </div>
        </div>
      ...
      <p class="text-center link-bawah">
        <a href="{{ asset('/') }}">Back to Homepage</a> | <a href="{{ url('forgot-password') }}">Forgot password?</a>
      </p>
