    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item">
              <a href="{{ asset('admin/paket-iklan') }}" class="nav-link">
                <i class="nav-icon fas fa-gift"></i><p>Kategori Paket Iklan</p>
              </a>
            </li>
		  ...
		  <li class="batas"><hr> <span class="infoku"><i class="fa fa-certificate"></i> Transaksi &amp; Iklan</span></li>
          <li class="batas"><hr></li>
       {{-- MENU BARU UNTUK USER MELENGKAPI PROFIL --}}
 
             <li class="nav-item">
              {{-- Link ini sekarang dinamis mengambil id_staff dari session --}}
              <a href="{{ asset('admin/staff/edit/'.Session::get('id_staff')) }}" class="nav-link">
                <i class="nav-icon fas fa-user-edit"></i><p>Profil Member</p>
              </a>
            </li>
          
            <li class="nav-item">
              <a href="{{ asset('admin/paket-iklan/beli-untuk-member') }}" class="nav-link">
                <i class="nav-icon fas fa-shopping-cart"></i><p>Beli Paket untuk Member</p>
              </a>
            </li>
            ...
            <li class="nav-item">
              <a href="{{ asset('admin/transaksi') }}" class="nav-link">
                <i class="nav-icon fas fa-bell"></i><p>Permintaan Aktivasi</p>
              </a>
            </li>
			@endif
		
		 @if(Session::get('akses_level') == 'Admin' || Session::get('is_member'))
