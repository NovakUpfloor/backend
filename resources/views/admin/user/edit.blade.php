...
<div class="form-group row">
	<label class="col-sm-3 control-label text-right">Password <p class="text-danger">*Wajib diisi ulang</p> </label>
	<div class="col-sm-9">
		<input type="password" name="password" class="form-control" placeholder="password" value="<?php Session::get('nodbpswrd') ?>" required>
	</div>
</div>
